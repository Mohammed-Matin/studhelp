...
router.patch('/:id/members/:userId', authenticateUser, updateMemberRole);
...
// ─── Join Requests ───────────────────────────────────────────
router.post('/:id/requests', authenticateUser, requestJoin);
...
// ─── Follower Messages ──────────────────────────────────────
router.post('/:id/messages', authenticateUser, sendFollowerMessage);
...
router.post('/:id/budget/transactions', authenticateUser, addBudgetTransaction);
